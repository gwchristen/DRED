    ...
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolStrip.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
                ...
                tsbImport, tsbExport, tsSep3, tsbSettings });
            this.toolStrip.Location = new System.Drawing.Point(0, 0);
            this.toolStrip.Size = new System.Drawing.Size(900, 25);
            this.toolStrip.TabIndex = 0;

            SetToolButton(tsbAdd,      "Add Record",      "➕", this.btnAdd_Click);
            SetToolButton(tsbEdit,     "Edit Record",     "✏",  this.btnEdit_Click);
            SetToolButton(tsbDelete,   "Delete Record",   "🗑", this.btnDelete_Click);
            SetToolButton(tsbRefresh,  "Refresh",         "🔄", this.btnRefresh_Click);
            SetToolButton(tsbImport,   "Import from Excel","📥", this.btnImport_Click);
            SetToolButton(tsbExport,   "Export to Excel", "📤", this.btnExport_Click);
            SetToolButton(tsbSettings, "Settings",        "⚙",  this.btnSettings_Click);
